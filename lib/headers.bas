...
DECLARE FUNCTION SQR AS BYTE (num AS WORD) OVERRIDE SHARED STATIC INLINE
DECLARE FUNCTION SQR AS WORD (num AS LONG) OVERRIDE SHARED STATIC INLINE
DECLARE FUNCTION SQR AS FLOAT (num AS FLOAT) OVERRIDE SHARED STATIC INLINE
...
DECLARE FUNCTION POW AS FLOAT (base AS FLOAT, exp AS FLOAT) OVERRIDE SHARED STATIC INLINE
...
DECLARE FUNCTION SHL AS INT (num AS INT, n AS BYTE) OVERRIDE SHARED STATIC INLINE
DECLARE FUNCTION SHL AS WORD (num AS WORD, n AS BYTE) OVERRIDE SHARED STATIC INLINE
DECLARE FUNCTION SHL AS LONG (num AS LONG, n AS BYTE) OVERRIDE SHARED STATIC INLINE
DECLARE FUNCTION SHR AS BYTE (num AS BYTE, n AS BYTE) SHARED STATIC INLINE
DECLARE FUNCTION SHR AS INT (num AS INT, n AS BYTE) OVERRIDE SHARED STATIC INLINE
DECLARE FUNCTION SHR AS WORD (num AS WORD, n AS BYTE) OVERRIDE SHARED STATIC INLINE
DECLARE FUNCTION SHR AS LONG (num AS LONG, n AS BYTE) OVERRIDE SHARED STATIC INLINE
