...
private char[] petscii = [
    ...
    0x90, 0x91, '\x92', 0x93, 0x94, 0x95, 0x96, 0x97, 0x98, 0x99, 0x9a, 0x9b, 0x9c, 0x9d, 0x9e, 0x9f,
...
{
    long index = indexOf(petscii, asciiChar);
    if(index < 0) {
        throw new Exception("Char not found: " ~ to!string(to!int(asciiChar)));
    }
    return to!ubyte(index);
}
