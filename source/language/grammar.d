...
struct GenericXCBASIC(TParseTree)
{
    ...
    static TParseTree Let_stmt(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.or!(pegged.peg.and!(pegged.peg.caseInsensitiveLiteral!("let"), pegged.peg.discard!(WS)), eps), Accessor, pegged.peg.discard!(pegged.peg.option!(WS)), pegged.peg.literal!("="), pegged.peg.discard!(pegged.peg.option!(WS)), Expression), "XCBASIC.Let_stmt")(p);
        }
        else
        {
            ...
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.or!(pegged.peg.and!(pegged.peg.caseInsensitiveLiteral!("let"), pegged.peg.discard!(WS)), eps), Accessor, pegged.peg.discard!(pegged.peg.option!(WS)), pegged.peg.literal!("="), pegged.peg.discard!(pegged.peg.option!(WS)), Expression), "XCBASIC.Let_stmt"), "Let_stmt")(p);
    ...
    static TParseTree Let_stmt(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.or!(pegged.peg.and!(pegged.peg.caseInsensitiveLiteral!("let"), pegged.peg.discard!(WS)), eps), Accessor, pegged.peg.discard!(pegged.peg.option!(WS)), pegged.peg.literal!("="), pegged.peg.discard!(pegged.peg.option!(WS)), Expression), "XCBASIC.Let_stmt")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.or!(pegged.peg.and!(pegged.peg.caseInsensitiveLiteral!("let"), pegged.peg.discard!(WS)), eps), Accessor, pegged.peg.discard!(pegged.peg.option!(WS)), pegged.peg.literal!("="), pegged.peg.discard!(pegged.peg.option!(WS)), Expression), "XCBASIC.Let_stmt"), "Let_stmt")(TParseTree("", false,[], s));
        }
    }
    ...
    static TParseTree Volume_stmt(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.caseInsensitiveLiteral!("volume"), pegged.peg.discard!(WS), ExprList), "XCBASIC.Volume_stmt")(p);
        }
        else
        {
            ...
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.caseInsensitiveLiteral!("volume"), pegged.peg.discard!(WS), ExprList), "XCBASIC.Volume_stmt"), "Volume_stmt")(p);
    ...
    static TParseTree Volume_stmt(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.caseInsensitiveLiteral!("volume"), pegged.peg.discard!(WS), ExprList), "XCBASIC.Volume_stmt")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.caseInsensitiveLiteral!("volume"), pegged.peg.discard!(WS), ExprList), "XCBASIC.Volume_stmt"), "Volume_stmt")(TParseTree("", false,[], s));
        }
    }
    ...
    static TParseTree Filter_stmt(TParseTree p)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.caseInsensitiveLiteral!("filter"), pegged.peg.option!(pegged.peg.and!(pegged.peg.discard!(WS), Number)), pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.discard!(WS), FilterSubCmd))), "XCBASIC.Filter_stmt")(p);
        }
        else
        {
            ...
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.caseInsensitiveLiteral!("filter"), pegged.peg.option!(pegged.peg.and!(pegged.peg.discard!(WS), Number)), pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.discard!(WS), FilterSubCmd))), "XCBASIC.Filter_stmt"), "Filter_stmt")(p);
    ...
    static TParseTree Filter_stmt(string s)
    {
        if(__ctfe)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.caseInsensitiveLiteral!("filter"), pegged.peg.option!(pegged.peg.and!(pegged.peg.discard!(WS), Number)), pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.discard!(WS), FilterSubCmd))), "XCBASIC.Filter_stmt")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.caseInsensitiveLiteral!("filter"), pegged.peg.option!(pegged.peg.and!(pegged.peg.discard!(WS), Number)), pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.discard!(WS), FilterSubCmd))), "XCBASIC.Filter_stmt"), "Filter_stmt")(TParseTree("", false,[], s));
        }
    }
