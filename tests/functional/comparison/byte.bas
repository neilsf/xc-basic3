' Tests BYTE comparison operators in XC=BASIC
' MONITOR: m c000 c04f

DIM results(80) AS BYTE @ $C000
DIM loVal AS BYTE, eqVal AS BYTE, hiVal AS BYTE
DIM fastLo AS BYTE FAST
DIM fastEq AS BYTE FAST
DIM fastHi AS BYTE FAST
DIM vals(3) AS BYTE

MEMSET $C000, 80, 0

loVal = 10 : eqVal = 42 : hiVal = 200
...
fastLo = 10 : fastEq = 42 : fastHi = 200
...
vals(0) = 10 : vals(1) = 42 : vals(2) = 200
...
IF 42 = 42 THEN results(42) = 255 ELSE results(42) = 0
IF 10 = 200 THEN results(43) = 255 ELSE results(43) = 0
IF 10 < 200 THEN results(44) = 255 ELSE results(44) = 0
IF 200 < 10 THEN results(45) = 255 ELSE results(45) = 0
IF 200 > 10 THEN results(46) = 255 ELSE results(46) = 0
IF 10 > 200 THEN results(47) = 255 ELSE results(47) = 0
IF 42 <= 42 THEN results(48) = 255 ELSE results(48) = 0
IF 10 <= 200 THEN results(49) = 255 ELSE results(49) = 0
IF 200 <= 10 THEN results(50) = 255 ELSE results(50) = 0
IF 42 >= 42 THEN results(51) = 255 ELSE results(51) = 0
IF 200 >= 10 THEN results(52) = 255 ELSE results(52) = 0
IF 10 >= 200 THEN results(53) = 255 ELSE results(53) = 0
IF 10 <> 200 THEN results(54) = 255 ELSE results(54) = 0
IF 42 <> 42 THEN results(55) = 255 ELSE results(55) = 0

IF loVal + 1 = 11 THEN results(56) = 255 ELSE results(56) = 0
