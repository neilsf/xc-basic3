' Tests DECIMAL comparison operators in XC=BASIC
' MONITOR: m c000 c04f

DIM results(80) AS BYTE @ $C000
DIM loVal AS DECIMAL, eqVal AS DECIMAL, hiVal AS DECIMAL
DIM fastLo AS DECIMAL FAST
DIM fastEq AS DECIMAL FAST
DIM fastHi AS DECIMAL FAST
DIM vals(3) AS DECIMAL

MEMSET $C000, 80, 0

loVal = 12d : eqVal = 1234d : hiVal = 9876d
...
fastLo = 12d : fastEq = 1234d : fastHi = 9876d
...
vals(0) = 12d : vals(1) = 1234d : vals(2) = 9876d
...
IF 1234d = 1234d THEN results(42) = 255 ELSE results(42) = 0
IF 12d = 9876d THEN results(43) = 255 ELSE results(43) = 0
IF 12d < 9876d THEN results(44) = 255 ELSE results(44) = 0
IF 9876d < 12d THEN results(45) = 255 ELSE results(45) = 0
IF 9876d > 12d THEN results(46) = 255 ELSE results(46) = 0
IF 12d > 9876d THEN results(47) = 255 ELSE results(47) = 0
IF 1234d <= 1234d THEN results(48) = 255 ELSE results(48) = 0
IF 12d <= 9876d THEN results(49) = 255 ELSE results(49) = 0
IF 9876d <= 12d THEN results(50) = 255 ELSE results(50) = 0
IF 1234d >= 1234d THEN results(51) = 255 ELSE results(51) = 0
IF 9876d >= 12d THEN results(52) = 255 ELSE results(52) = 0
IF 12d >= 9876d THEN results(53) = 255 ELSE results(53) = 0
IF 12d <> 9876d THEN results(54) = 255 ELSE results(54) = 0
IF 1234d <> 1234d THEN results(55) = 255 ELSE results(55) = 0

IF loVal + 1d = 13d THEN results(56) = 255 ELSE results(56) = 0
IF loVal + 1d = hiVal - 1d THEN results(57) = 255 ELSE results(57) = 0
IF loVal + 1d < hiVal - 1d THEN results(58) = 255 ELSE results(58) = 0
IF hiVal - 1d < loVal + 1d THEN results(59) = 255 ELSE results(59) = 0
IF hiVal - 1d > loVal + 1d THEN results(60) = 255 ELSE results(60) = 0
IF loVal + 1d > hiVal - 1d THEN results(61) = 255 ELSE results(61) = 0
IF eqVal + 1d <= eqVal + 1d THEN results(62) = 255 ELSE results(62) = 0
IF loVal + 1d <= hiVal - 1d THEN results(63) = 255 ELSE results(63) = 0
IF hiVal - 1d <= loVal + 1d THEN results(64) = 255 ELSE results(64) = 0
IF eqVal + 1d >= eqVal + 1d THEN results(65) = 255 ELSE results(65) = 0
IF hiVal - 1d >= loVal + 1d THEN results(66) = 255 ELSE results(66) = 0
IF loVal + 1d >= hiVal - 1d THEN results(67) = 255 ELSE results(67) = 0
IF loVal + 1d <> hiVal - 1d THEN results(68) = 255 ELSE results(68) = 0
IF eqVal + 1d <> eqVal + 1d THEN results(69) = 255 ELSE results(69) = 0