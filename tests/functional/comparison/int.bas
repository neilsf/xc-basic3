' Tests INT comparison operators in XC=BASIC
' MONITOR: m c000 c07f

DIM results(128) AS BYTE @ $C000
DIM loVal AS INT, eqVal AS INT, hiVal AS INT
DIM minVal AS INT, negVal AS INT, zeroVal AS INT, posVal AS INT, maxVal AS INT
DIM fastLo AS INT FAST
DIM fastEq AS INT FAST
DIM fastHi AS INT FAST
DIM fastMin AS INT FAST
DIM fastNeg AS INT FAST
DIM fastZero AS INT FAST
DIM fastPos AS INT FAST
DIM fastMax AS INT FAST
DIM vals(3) AS INT
DIM bounds(5) AS INT

MEMSET $C000, 128, 0

loVal = -123 : eqVal = -50 : hiVal = 456
...
fastLo = -123 : fastEq = -50 : fastHi = 456
...
vals(0) = -123 : vals(1) = -50 : vals(2) = 456
...
IF -50 = -50 THEN results(42) = 255 ELSE results(42) = 0
IF -123 = 456 THEN results(43) = 255 ELSE results(43) = 0
IF -123 < 456 THEN results(44) = 255 ELSE results(44) = 0
IF 456 < -123 THEN results(45) = 255 ELSE results(45) = 0
IF 456 > -123 THEN results(46) = 255 ELSE results(46) = 0
IF -123 > 456 THEN results(47) = 255 ELSE results(47) = 0
IF -50 <= -50 THEN results(48) = 255 ELSE results(48) = 0
IF -123 <= 456 THEN results(49) = 255 ELSE results(49) = 0
IF 456 <= -123 THEN results(50) = 255 ELSE results(50) = 0
IF -50 >= -50 THEN results(51) = 255 ELSE results(51) = 0
IF 456 >= -123 THEN results(52) = 255 ELSE results(52) = 0
IF -123 >= 456 THEN results(53) = 255 ELSE results(53) = 0
IF -123 <> 456 THEN results(54) = 255 ELSE results(54) = 0
IF -50 <> -50 THEN results(55) = 255 ELSE results(55) = 0

IF loVal + 1 = -122 THEN results(56) = 255 ELSE results(56) = 0
...
minVal = -32768 : negVal = -1 : zeroVal = 0 : posVal = 1 : maxVal = 32767
...
IF minVal = -32768 THEN results(80) = 255 ELSE results(80) = 0
IF maxVal = 32767 THEN results(81) = 255 ELSE results(81) = 0
IF -32768 < 32767 THEN results(82) = 255 ELSE results(82) = 0
IF 32767 > -32768 THEN results(83) = 255 ELSE results(83) = 0
IF -1 < 1 THEN results(84) = 255 ELSE results(84) = 0
IF 1 < -1 THEN results(85) = 255 ELSE results(85) = 0

fastMin = -32768 : fastNeg = -1 : fastZero = 0 : fastPos = 1 : fastMax = 32767
...
bounds(0) = -32768 : bounds(1) = -1 : bounds(2) = 0 : bounds(3) = 1 : bounds(4) = 32767
...
IF minVal + 10 > maxVal - 10 THEN results(110) = 255 ELSE results(110) = 0
IF maxVal - 10 < minVal + 10 THEN results(111) = 255 ELSE results(111) = 0
IF minVal + 32767 = negVal THEN results(112) = 255 ELSE results(112) = 0
IF maxVal - 32766 = posVal THEN results(113) = 255 ELSE results(113) = 0