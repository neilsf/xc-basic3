' Tests WORD comparison operators in XC=BASIC
' MONITOR: m c000 c04f

DIM results(80) AS BYTE @ $C000
DIM loVal AS WORD, eqVal AS WORD, hiVal AS WORD
DIM fastLo AS WORD FAST
DIM fastEq AS WORD FAST
DIM fastHi AS WORD FAST
DIM vals(3) AS WORD

MEMSET $C000, 80, 0

loVal = 1000 : eqVal = 40000 : hiVal = 60000
...
fastLo = 1000 : fastEq = 40000 : fastHi = 60000
...
vals(0) = 1000 : vals(1) = 40000 : vals(2) = 60000
...
IF 40000 = 40000 THEN results(42) = 255 ELSE results(42) = 0
IF 1000 = 60000 THEN results(43) = 255 ELSE results(43) = 0
IF 1000 < 60000 THEN results(44) = 255 ELSE results(44) = 0
IF 60000 < 1000 THEN results(45) = 255 ELSE results(45) = 0
IF 60000 > 1000 THEN results(46) = 255 ELSE results(46) = 0
IF 1000 > 60000 THEN results(47) = 255 ELSE results(47) = 0
IF 40000 <= 40000 THEN results(48) = 255 ELSE results(48) = 0
IF 1000 <= 60000 THEN results(49) = 255 ELSE results(49) = 0
IF 60000 <= 1000 THEN results(50) = 255 ELSE results(50) = 0
IF 40000 >= 40000 THEN results(51) = 255 ELSE results(51) = 0
IF 60000 >= 1000 THEN results(52) = 255 ELSE results(52) = 0
IF 1000 >= 60000 THEN results(53) = 255 ELSE results(53) = 0
IF 1000 <> 60000 THEN results(54) = 255 ELSE results(54) = 0
IF 40000 <> 40000 THEN results(55) = 255 ELSE results(55) = 0

IF loVal + 1 = 1001 THEN results(56) = 255 ELSE results(56) = 0
