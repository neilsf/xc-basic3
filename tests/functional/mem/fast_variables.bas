' Tests memory commands with FAST variable arguments in XC=BASIC
' MONITOR: m c000 c07f

DIM results(128) AS BYTE @ $C000
DIM base AS WORD FAST
DIM addr AS WORD FAST
DIM addr2 AS WORD FAST
DIM source AS WORD FAST
DIM dest AS WORD FAST
DIM count AS WORD FAST
DIM value AS BYTE FAST
DIM wordValue AS WORD FAST
